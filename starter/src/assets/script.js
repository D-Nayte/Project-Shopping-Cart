...
function addProductToCart (productId) {
  ...
  if (!cart.find((product) => product.productId === productId) || cart.length === 0) {
    products[productsQuantityIndex].quantity = 1;
...
function increaseQuantity(productId) {
  const productsIndex = products.findIndex((product) => product.productId === productId);
  products[productsIndex].quantity += 1;
}
...
function decreaseQuantity(productId) {
  ...
  const productsProductQuantity = products[productsIndex].quantity;
  if (productsProductQuantity === 1) {
    products[productsIndex].quantity = 0;
